...
user|no|A user account under which all database and table operation will be performed. On non-Kerberos cluster this will determine table ownership.<br>Default: The [`ssh_user`](../inventory/hosts) defined for this relay host.
